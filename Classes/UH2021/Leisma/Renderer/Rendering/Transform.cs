...
{
    /// <summary>
    /// Una clase static que contiene metodos de transformaciones elementales
    /// </summary>
    public static class Transform
    {
        ...
        /// <summary>
        /// Construye una matriz de rotacion usando los offset especificados
        /// </summary>
        /// <param name="offsetX"></param>
        /// <param name="offsetY"></param>
        /// <param name="offsetZ"></param>
        /// <returns></returns>
        public static float4x4 Translate(float offsetX, float offsetY, float offsetZ)
        {
            return float4x4(
                1,         0,      0,      0,
                0,         1,      0,      0,
        ...
        /// <summary>
        /// Devuelve una matriz de traslacion a partir de un vector de offset
        /// </summary>
        /// <param name="vec">El vector por el que se desplazara</param>
        /// <returns></returns>
        public static float4x4 Translate(float3 vec) => Translate(vec.x,vec.y,vec.z);
        ...
        /// <summary>
        /// Devuelve una matriz de rotacion alrededor de un eje 'dir'
        /// </summary>
        /// <param name="angle">El angulo con el que se rotara</param>
        /// <param name="dir">El vector alrededor del cual se rotara</param>
        /// <returns></returns>
